...
<body>
  ...
  <header class="navbar">
    <div class="container nav-inner">
      ...
      <div class="nav-actions">
        <a href="https://wa.me/6287846560510?text=Halo%20Admin%20XL%20SATU,%20mau%20tanya%20info%20paket%20dan%20promo" target="_blank" class="btn btn-secondary" style="padding: 8px 18px; font-size: 13.5px;">
  ...
  <script>
    ...
    function renderArticles() {
      ...
      // Featured Item: Gunakan artikel pertama jika tidak sedang search khusus
...
"""
    ...
    with open('/root/exelsatu/blog.html', 'w', encoding='utf-8') as f:
        f.write(html)
    print("✓ Berhasil generate /root/exelsatu/blog.html")

def build_artikel_html():
    with open('/root/exelsatu/data/articles.json', 'r', encoding='utf-8') as f:
        articles = json.load(f)

    # Simpan articles JSON string untuk di-embed atau fallback di client
    # Untuk efisiensi, embed metadata ringkas 30 artikel untuk related posts & list
    summary_list = []
    for a in articles:
        summary_list.append({
            'slug': a['slug'],
    ...
    # Embed artikel pertama sebagai default SSR fallback
